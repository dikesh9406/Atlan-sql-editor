      ...
      {query ? (
        <section className="text-gray-600 body-font pl-4">
          <div className="flex w-full justify-between mt-6 lg:mt-0">
            <div className="font-bold text-center py-2 px-6 bg-gray-500 text-white rounded-tl-md rounded-tr-lg">
              Output
            </div>
            <CSVLink
              data={csvData}
              ...
              className="p-2"
            >
              <button className="flex mx-auto text-white bg-blue-500 border-0 py-1 h-9 px-3 focus:outline-none hover:bg-indigo-600 rounded text-lg justify-center items-center">
                <svg
        ...
        <div className="w-full flex text-center h-80 justify-center items-center font-bold font-mono text-gray-400 text-2xl px-6">
          Run a Query & Your Output Shall Appear!
        </div>
      )}
    </div>
  );
